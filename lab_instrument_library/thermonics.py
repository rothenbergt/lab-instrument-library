...
class TemperatureController(ABC):
    ...
    def wait_for_temperature(self, target_temp: float, tolerance: float = 1.0, 
                           timeout: float = 300, check_interval: float = 5.0,
        ...
        try:
            while elapsed < timeout:
                ...
                # Print status
                print(f"\rCurrent: {current_temp:.2f}°C, Target: {target_temp:.2f}°C, Elapsed: {int(elapsed)}s/{int(timeout)}s", end="")
...
class Thermonics:
    ...
    def __init__(self, instrument_address: str = "GPIB0::21::INSTR", 
    ...
    def wait_for_temperature(self, target_temp: float, tolerance: float = 1.0, 
        ...
        return self.controller.wait_for_temperature(
            target_temp, tolerance, timeout, check_interval, callback)
    ...
    def close(self) -> None:
        ...
        try:
            ...
            logger.info(f"Connection to temperature controller closed")
        except Exception as e:
