...
import traceback
import time
from typing import Callable, Any, TypeVar, Optional, Dict, Union, List, Tuple, cast, Type
        ...
        def wrapper(self, *args: Any, **kwargs: Any) -> Union[T, Any]:
            ...
            while attempt < max_attempts:
                try:
                    ...
                    if log_success:
                        log.debug(f"Successfully executed {func.__name__} on {instrument_id} "
                    ...
                    error_msg = (f"Unexpected error in {func.__name__} on {instrument_id} at {address}: "
